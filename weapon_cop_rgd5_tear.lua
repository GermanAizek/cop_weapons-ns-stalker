...
SWEP.ViewModel     = "models/weapons/stalker_cop/v_rgd5.mdl"
SWEP.WorldModel    = "models/weapons/ssk/spenser/w_ssk_rgd.mdl"
...
SWEP.Primary.Ammo        = "COP_RGD5"

SWEP.OriginPos = Vector(-4, 0, -9)
			...
			if SERVER then
				timer.Simple(0.4, function()
					if IsValid(self) then
						...
						local nade = ents.Create("nut_teargas")
